...
// e chega na raiz do projeto automaticamente
 ...
 //require_once 'C:/xampp/htdocs/hacktoon/config.php'; depois de arrumado testar esse
...
<header class="navbar">
  ...
  <nav class="nav-links" id="nav-links">
      <a href="<?= BASE_URL ?>/aluno/vagas.php"        class="<?= $paginaAtiva==='vagas'       ?'ativo':'' ?>">Vagas</a>
      <a href="<?= BASE_URL ?>/aluno/candidaturas.php"  class="<?= $paginaAtiva==='candidaturas'?'ativo':'' ?>">Minhas Candidaturas</a>
      <a href="<?= BASE_URL ?>/aluno/cadastro.php"      class="<?= $paginaAtiva==='cadastro'    ?'ativo':'' ?>">Cadastrar Aluno</a>
      <a href="<?= BASE_URL ?>/empresa/empresa.php"       class="<?= $paginaAtiva==='empresa'     ?'ativo':'' ?>">Sou Empresa &#711;</a>
    </nav>
  <a href="<?= BASE_URL ?>/login.php" class="navbar-btn">
    Login
